...
**跨电商 AI 虚拟试衣 · 网页 + 浏览器插件 · 可在一张 8GB 笔记本显卡上本地运行 · 模型全部可商用**

[English](README.en.md) · [效果](#效果) · [功能](#功能) · [架构](#架构) · [技术亮点](#技术亮点) · [快速开始](#快速开始)

![同一套衣服穿到不同体型的模特上](docs/assets/showcase.jpg)

<sub>上图为真实运行结果：输入两张商品平铺图（示例图来自阿里云官方文档），输出由本地 RTX 4060 Laptop（8GB）上的 FASHN VTON v1.5 生成；模特为 AI 生成的虚拟模特。</sub>
